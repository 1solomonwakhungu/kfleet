...
type Store interface {
	...
	ListAlertsForTenant(ctx context.Context, tenantID string, status types.AlertStatus, limit int) ([]types.Alert, error)
	GetAlert(ctx context.Context, id string) (types.Alert, error)
	GetAlertForTenant(ctx context.Context, tenantID, id string) (types.Alert, error)
	AcknowledgeAlert(ctx context.Context, id, acknowledgedBy string, acknowledgedAt time.Time) error
	AcknowledgeAlertForTenant(ctx context.Context, tenantID, id, acknowledgedBy string, acknowledgedAt time.Time) error
